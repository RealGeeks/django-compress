...
COMPRESS_VERSION_QUERYSTRING = getattr(settings, 'COMPRESS_VERSION_QUERYSTRING', False)
COMPRESS_VERSION_QUERYSTRING_VAR = getattr(settings, 'COMPRESS_VERSION_QUERYSTRING_VAR', 'v')
