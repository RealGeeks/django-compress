...
* </tt>COMPRESS_VERSION_QUERYSTRING</tt>: When </tt>True</tt>, appends version to compressed url as a querystring.
* </tt>COMPRESS_VERSION_QUERYSTRING_VAR</tt>: Variable to use for querystring. Defaults to </tt>v</tt>.
